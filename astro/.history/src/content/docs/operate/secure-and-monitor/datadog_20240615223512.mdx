...
![Datadog-Website-New-Dashbaord-Configuration](/img/docs/operate/secure-and-monitor/datadog-website-new-dashboard-preview.png)

## Adding OpenMetrics Integration Datadog.
