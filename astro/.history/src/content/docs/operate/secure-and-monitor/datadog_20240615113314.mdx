...
- [Import Data To Splunk With Logs](#import-data-to-datadog-with-logs)
- [Further Reading](#further-reading)
- [TODO](#todo)

## Introduction

as well as which FusionAuth metrics map to what categories in Splunk and how to create a simple dashboard to them.
In this guide, we will explain how to connect FusionAuth to Datadog through docker with OpenTelemetry, by using the Datadog Agent and also adding logs or events using the Datadog API. We will create and setup a datadog acount and create a simple dashboard to monitor these metrics from FusionAuth.
