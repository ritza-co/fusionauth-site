...
Next, you configure your webhook to sign the event with this key. From <Breadcrumb>Settings -> Webhooks</Breadcrumb>, click on the <Breadcrumb>Edit</Breadcrumb> button for your webhook (or create a new webhook). Select the <Breadcrumb>Security</Breadcrumb> tab panel. Once you enable **Sign events**, a **Signing key** select dropdown allows you to choose the generated key. Be sure to click <Breadcrumb>Save</Breadcrumb> in the upper right corner.
...
<LocalCode title="Example Node.js Webhook Signature Verifier" lang="javascript" src="example-javascript-webhooks/signature-verify/app.js" />
