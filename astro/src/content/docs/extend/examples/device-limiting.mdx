...
<LocalCode src="example-device-limit-simple/index.snippet.device-limiting.ts" lang="typescript" />
...
<LocalCode src="example-device-limit-friendly/index.snippet.oauth-logout.ts" lang="typescript" />
...
<LocalCode src="example-device-limit-friendly/index.snippet.get-active-devicelist.ts" lang="typescript" />
...
<LocalCode src="example-device-limit-friendly/index.snippet.make-change-check-devicelimit.ts" lang="typescript" />
...
<LocalCode src="example-device-limit-friendly/index.snippet.views-hbs.ts" lang="typescript" />

 You will need a GET route to render the `device-limit` page. The route should look something like the following.

<LocalCode src="example-device-limit-friendly/index.snippet.device-limiting-maxcount.ts" lang="typescript" />
...
<LocalCode src="example-device-limit-friendly/index.snippet.device-limiting-validatetoken.ts" lang="typescript" />
