...
<LocalCode lang="javascript" title="The Logout Link" src="example-5-minute-guide/index.snippet.logoutLink.pug" />
...
<LocalCode lang="javascript" title="Destroying the Local Session" src="example-5-minute-guide/index.snippet.logoutRoute.js" />
