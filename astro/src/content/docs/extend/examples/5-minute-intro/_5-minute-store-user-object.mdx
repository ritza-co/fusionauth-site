...
<LocalCode lang="javascript" src="example-5-minute-guide/routes/index.js.snippet.fullOAuthCodeExchange.js" title="The Complete OAuth Code Exchange Function" />
...
There are other options for storing this user object, but for this tutorial, this will work fine. If you want to learn more, such as other patterns for storing the token, please check out [these articles about login workflows](/articles/login-authentication-workflows/).
