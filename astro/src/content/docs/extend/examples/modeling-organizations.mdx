...
<LocalCode src="example-modeling-organizations/loadGrants.snippet.loadGrantsMW.js" lang="javascript" />

The `loadGrants` function is then added to the Express `app` request pipeline:

<LocalCode src="example-modeling-organizations/app.snippet.loadGrantsPipeline.js" lang="javascript" />
...
<LocalCode src="example-modeling-organizations/app.snippet.loadGrantsPassport.js" lang="javascript" />
...
<LocalCode src="example-modeling-organizations/checkGrantPermissions.snippet.checkGrantPermissions.js" lang="javascript" />

This middleware function can be used on individual routes as below.

<LocalCode src="example-modeling-organizations/billing.snippet.billingPost.js" lang="javascript" />
...
<LocalCode src="example-modeling-organizations/index.snippet.companyPost.js" lang="javascript" />
...
<LocalCode src="example-modeling-organizations/users.snippet.getGrantsForAllUsers.js" lang="javascript" />
...
<LocalCode src="example-modeling-organizations/admin.snippet.updateEntity.js" lang="javascript" />
