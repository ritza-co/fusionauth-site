...
A structure like this CRM introduces a lot of complexity. This is where FusionAuth's [Entity Management](/docs/get-started/core-concepts/types/entity-management) feature comes in handy. Entity Management allows you to create objects (that is, Entities) and grant Users permissions to them. Users aren't limited to having permissions to just one Entity; Users can be granted different permissions to different Entities.

<PlanBlurb plan="starter" />

This guide will walk you through implementing the use case described above with Entity Management using the FusionAuth APIs. See the [core concepts for Entity Management](/docs/get-started/core-concepts/types/entity-management) documentation for more information. 
...
Replace the `userId` parameter with the Id of the user that is currently logged in. Retrieve the User's organization information from the access token JWT or the [UserInfo](/docs/apis/oauth/userinfo) or [Introspect](/docs/apis/oauth/introspect) APIs.
...
<LocalCode src="example-modeling-organizations/complete-application/middleware/loadGrants.js.snippet.loadGrants.js" lang="javascript" />

The `loadGrants` function is then added to the Express `app` request pipeline:

<LocalCode src="example-modeling-organizations/complete-application/app.js.snippet.loadGrantsPipeline.js" lang="javascript" />
...
<LocalCode src="example-modeling-organizations/complete-application/app.js.snippet.loadGrantsPassport.js" lang="javascript" />
...
<LocalCode src="example-modeling-organizations/complete-application/middleware/checkGrantPermissions.js.snippet.checkGrantPermissions.js" lang="javascript" />

This middleware function can be used on individual routes as below.

<LocalCode src="example-modeling-organizations/complete-application/routes/billing.js.snippet.billingPost.js" lang="javascript" />
...
<LocalCode src="example-modeling-organizations/complete-application/routes/index.js.snippet.companyPost.js" lang="javascript" />
...
<LocalCode src="example-modeling-organizations/complete-application/routes/users.js.snippet.getGrantsForAllUsers.js" lang="javascript" />
...
<LocalCode src="example-modeling-organizations/complete-application/routes/admin.js.snippet.updateEntity.js" lang="javascript" />
