...
<LocalCode lang="hcl" title="Example main.tf File" src="example-terraform/main.snippet.terraformProvider.tf" />
...
<LocalCode lang="hcl" title="Default Tenant Import" src="example-terraform/main.snippet.defaultTenantImport.tf" />
...
<LocalCode lang="hcl" title="A Data Source For The default Tenant" src="example-terraform/main.snippet.defaultTenantDataSource.tf" />

<LocalCode lang="hcl" title="A Data Source For The FusionAuth Application" src="example-terraform/main.snippet.defaultApplicationDataSource.tf" />
...
<LocalCode lang="hcl" title="main.tf Initial Sections" src="example-terraform/main.snippet.terraformProvider.tf" />

Then, configure the `Forum` Tenant; this Tenant will contain users and applications.

<LocalCode lang="hcl" title="Creating A Forum Tenant" src="example-terraform/main.snippet.createForumTenant.tf" />

Then, configure the signing key. This will be used to sign access tokens for the `Forum` Application.

<LocalCode lang="hcl" title="Creating A Signing Key" src="example-terraform/main.snippet.createKey.tf" />
...
<LocalCode lang="hcl" title="Creating An Email Template" src="example-terraform/main.snippet.createEmailTemplate.tf" />
...
<LocalCode lang="hcl" title="Creating A Forum Application In The Forum Tenant" src="example-terraform/main.snippet.createForumApplication.tf" />

Create the roles for the Application. These roles will be used by the `Forum` Application.

<LocalCode lang="hcl" title="Creating Roles In The Forum Application" src="example-terraform/main.snippet.createForumApplicationRoles.tf" />
...
<LocalCode lang="hcl" title="Default Tenant Import" src="example-terraform/main.snippet.defaultApplicationImport.tf" />
