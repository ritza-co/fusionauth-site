...
<TryInExplorer method="POST" path="/api/passwordless/start" tag="passwordless" />

## Request

Provide the Application Id and login Id to generate a passwordless code for that user.
