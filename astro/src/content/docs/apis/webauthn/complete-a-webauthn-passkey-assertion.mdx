...
<TryInExplorer method="POST" path="/api/webauthn/assert" tag="webauthn" />

## Request

Send the values returned from the WebAuthn JavaScript API call to confirm the user has access to the passkey.
