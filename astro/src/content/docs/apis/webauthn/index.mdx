...
<LocalCode src="example-javascript-webauthn/base64url-to-buffer.js" lang="javascript" title="Function to convert a base64url-encoded string to an ArrayBuffer" />
...
<LocalCode src="example-javascript-webauthn/buffer-to-base64url.js" lang="javascript" title="Function to convert an ArrayBuffer to a base64url-encoded string" />
