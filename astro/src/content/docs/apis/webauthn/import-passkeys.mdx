...
<TryInExplorer method="POST" path="/api/webauthn/import" tag="webauthn" />

## Request

Import multiple passkeys at once, useful for migrating data from an existing database into FusionAuth.
