...
<TryInExplorer method="POST" path="/api/webauthn/register/complete" tag="webauthn" />

## Request

Send the values returned from the WebAuthn JavaScript API call along with the one-time challenge to complete registration.
