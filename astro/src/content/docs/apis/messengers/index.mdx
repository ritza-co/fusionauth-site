...
<TryInExplorer method="GET" path="/api/messenger" tag="messengers" />

## Retrieve All Messengers

### Request

Retrieve all of the Messengers, or provide an Id to retrieve a single Messenger.

<API method="GET" uri="/api/messenger" authentication={["global-api-key"]} title="Retrieve all Messengers"/>

<API method="GET" uri="/api/messenger/{messengerId}" authentication={["global-api-key"]} title="Retrieve a Messenger by Id"/>
