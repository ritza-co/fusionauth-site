...
This API supports two ways to create a Simple Theme, either as a brand new Theme or by copying an existing Theme's settings.
...
#### Copy an Existing Simple Theme

<API method="POST" uri="/api/theme" authentication={["global-api-key"]} title="Create a Simple Theme from an existing Simple Theme with a randomly generated Id"/>

<API method="POST" uri="/api/theme/{themeId}" authentication={["global-api-key"]} title="Create a Simple Theme from an existing Simple Theme with the provided unique Id"/>
