...
<TryInExplorer method="POST" path="/api/user/refresh-token/import" />

## Request

Send the refresh tokens to import in the request body, referencing Users and Applications that already exist in FusionAuth.
