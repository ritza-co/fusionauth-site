...
This API is used to reactivate an inactive User. You must specify the Id of the User on the URI.

<TryInExplorer method="PUT" path="/api/user/{userId}" />

## Request

Identify the User to reactivate by Id on the URI.
