...
import EnterprisePlanBlurbApi from 'src/content/docs/_shared/_enterprise-plan-blurb-api.mdx';
...
<TryInExplorer method="GET" path="/api/user/recent-login" />

## Request

Paginate through recent logins for all Users, or filter to a single User by Id.
