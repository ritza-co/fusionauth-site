...
Identify the Users to delete either by a list of Ids or by a search query, and choose a soft or hard delete.
...
For larger requests than the query parameters above can support, send the same fields in a JSON request body instead.
