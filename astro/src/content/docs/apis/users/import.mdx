---
title: Import Users
htmlTitle: Import Users API
description: API documentation for the FusionAuth Import Users API.
order: 800
---
import API from 'src/components/api/API.astro';
import ImportUsersRequestBody from 'src/content/docs/apis/users/_import-users-request-body.mdx';
...
```ruby title="Example of Converting a Base16 Password Hash Value to Base64"
...
```ruby title="Convert a Hexadecimal Password Hash Value to Base64"
hash_in_hex = "25d55ad283aa400af464c76d713c07ad"
