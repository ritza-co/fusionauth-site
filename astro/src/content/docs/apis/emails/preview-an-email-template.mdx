...
<TryInExplorer method="POST" path="/api/email/template/preview" tag="email" />

## Request

Send all or part of the Email Template in the request body to see how it will render.
