...
<TryInExplorer method="PUT" path="/api/email/template/{emailTemplateId}" tag="email" />

## Request

Send the full Email Template object with your changes applied, identifying it by the Id on the URI.
