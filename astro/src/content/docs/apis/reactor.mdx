...
<TryInExplorer method="POST" path="/api/reactor" tag="reactor" />
...
Activate a Reactor license by sending the license Id or the Base64-encoded license value.

<API method="POST" uri="/api/reactor" authentication={["global-api-key"]} title="Activate a Reactor license"/>
...
Retrieve the metrics of Reactor features.

<API method="GET" uri="/api/reactor/metrics" authentication={["global-api-key"]} title="Retrieve Reactor metrics"/>
...
Retrieve the status of Reactor features.

<API method="GET" uri="/api/reactor" authentication={["global-api-key"]} title="Retrieve Reactor status"/>
...
Regenerate the Reactor license.

<API method="PUT" uri="/api/reactor" authentication={["global-api-key"]} title="Regenerate a Reactor license"/>
...
Deactivate the Reactor license.

<API method="DELETE" uri="/api/reactor" authentication={["global-api-key"]} title="Deactivate Reactor license"/>
