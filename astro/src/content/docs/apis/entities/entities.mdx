...
<API method="GET" uri="/api/entity/search?ids={uuid}&ids={uuid}" authentication={["api-key"]} title="Search for Entities by Id (Database Search Engine)"/>

<API method="GET" uri="/api/entity/search?queryString={queryString}" authentication={["api-key"]} title="Search for Entities by a query string (Database Search Engine)"/>

<API method="GET" uri="/api/entity/search?queryString={queryString}&sortFields[0].name={name}&sortFields[0].order={order}" authentication={["api-key"]} title="Search for Entities by a query string and sort the response (Database Search Engine)"/>
...
<API method="POST" uri="/api/entity/search" authentication={["api-key"]} title="Search for Entities using a JSON request body (Database Search Engine). This allows for larger requests than are possible using request parameters."/>
...
<API method="GET" uri="/api/entity/search?ids={uuid}&ids={uuid}" authentication={["api-key"]} title="Search for Entities by Id (Elasticsearch Search Engine)"/>

<API method="GET" uri="/api/entity/search?queryString={queryString}" authentication={["api-key"]} title="Search for Entities by a query string (Elasticsearch Search Engine)"/>

<API method="GET" uri="/api/entity/search?queryString={queryString}&sortFields[0].name={name}&sortFields[0].order={order}" authentication={["api-key"]} title="Search for Entities by a query string and sort the response (Elasticsearch Search Engine)"/>
...
<API method="POST" uri="/api/entity/search" authentication={["api-key"]} title="Search for Entities using a JSON request body (Elasticsearch Search Engine). This allows for larger requests than are possible using request parameters."/>
