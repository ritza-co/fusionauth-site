...
<TryInExplorer method="POST" path="/api/entity" tag="entities" />
...
Create an Entity with either a randomly generated Id or one you provide on the URI.
...
Update the Entity by sending the fields you want to change.
...
Issue the flush request to force any cached data to be written to disk.
