...
<Aside type="version">
Aailable since `1.26.0`
</Aside>

<TryInExplorer method="POST" path="/api/entity/{entityId}/grant" tag="entities" />
...
Create a Grant, or update an existing Grant.
...
Retrieve all Grants to this Entity, Grants to this Entity for a User, or Grants for another Entity.
...
Delete a Grant for a User, or for a Recipient Entity.
...
<API method="GET" uri="/api/entity/grant/search?entityId={uuid}" authentication={["global-api-key"]} title="Search for Grants by Entity Id"/>

<API method="GET" uri="/api/entity/grant/search?name={string}" authentication={["global-api-key"]} title="Search for Grants by Entity name"/>

<API method="GET" uri="/api/entity/grant/search?userId={uuid}" authentication={["global-api-key"]} title="Search for Grants by User Id"/>

#### Request Parameters

<EntityGrantSearchRequestParameters parameter_prefix="" />

<API method="POST" uri="/api/entity/grant/search" authentication={["global-api-key"]} title="Search for Grants using a JSON request body."/>
