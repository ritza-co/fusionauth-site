...
<TryInExplorer method="POST" path="/api/entity/type" tag="entities" />
...
Create an Entity Type with either a randomly generated Id or one you provide on the URI.

<API method="POST" uri="/api/entity/type" authentication={["global-api-key"]} title="Create an Entity Type without providing an Id. An Id will be automatically generated."/>

<API method="POST" uri="/api/entity/type/{entityTypeId}" authentication={["global-api-key"]} title="Create an Entity Type with the provided Id"/>
...
Retrieve all of the Entity Types, or provide an Id to retrieve a single Entity Type.

<API method="GET" uri="/api/entity/type" authentication={["global-api-key"]} title="Retrieve all of the Entity Types"/>

<API method="GET" uri="/api/entity/type/{entityTypeId}" authentication={["global-api-key"]} title="Retrieve a single Entity Type by Id"/>
...
Update the Entity Type by sending the fields you want to change.

<API method="PUT" uri="/api/entity/type/{entityTypeId}" authentication={["global-api-key"]} showPatch={true} title="Update an Entity Type by Id"/>
...
<API method="DELETE" uri="/api/entity/type/{entityTypeId}" authentication={["global-api-key"]} title="Delete an Entity Type By Id"/>
...
<API method="GET" uri="/api/entity/type/search?name={name}" authentication={["global-api-key"]} title="Search Entity Types"/>
...
Create a permission with either a randomly generated Id or one you provide on the URI.

<API method="POST" uri="/api/entity/type/{entityTypeId}/permission" authentication={["global-api-key"]} title="Create a Permission with a randomly generated Id"/>

<API method="POST" uri="/api/entity/type/{entityTypeId}/permission/{permissionId}" authentication={["global-api-key"]} title="Create a Permission with a given Id"/>
...
Update the permission by sending the fields you want to change.

<API method="PUT" uri="/api/entity/type/{entityTypeId}/permission/{permissionId}" authentication={["global-api-key"]} showPatch={true} title="Update an Entity Type Permission by Id"/>
...
Delete an Entity Type Permission by Id, or by name.

<API method="DELETE" uri="/api/entity/type/{entityTypeId}/permission/{permissionId}" authentication={["global-api-key"]} title="Delete an Entity Type Permission by Id"/>
...
<API method="DELETE" uri="/api/entity/type/{entityTypeId}/permission?name={name}" authentication={["global-api-key"]} title="Delete an Entity Type Permission by name"/>
