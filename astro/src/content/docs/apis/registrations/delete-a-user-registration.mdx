...
<TryInExplorer method="DELETE" path="/api/user/registration/{userId}/{applicationId}" />

## Request

Identify the registration to remove by the User Id and Application Id on the URI.
