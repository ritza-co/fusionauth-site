...
Create a LDAP Connector with either a randomly generated Id or one you provide on the URI.
...
Retrieve the LDAP Connector by its Id.
...
Update the LDAP Connector by sending the fields you want to change.
...
Delete the LDAP Connector by its Id.
