...
<TryInExplorer method="GET" path="/api/connector" tag="connectors" />

## Retrieve All Connectors

### Request

Retrieve all of the Connectors, or provide an Id to retrieve a single Connector.

<API method="GET" uri="/api/connector" authentication={["global-api-key"]} title="Retrieve all Connectors"/>

<API method="GET" uri="/api/connector/{connectorId}" authentication={["global-api-key"]} title="Retrieve a Connector by Id"/>
