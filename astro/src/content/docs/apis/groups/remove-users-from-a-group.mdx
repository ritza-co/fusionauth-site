...
<TryInExplorer method="DELETE" path="/api/group/member/{memberId}" tag="groups" />

## Request

Remove a single User from a Group by Member Id, by User Id and Group Id, remove all Users from a Group, or remove specific Users from a Group by Member Id or Group Id.

<API method="DELETE" uri="/api/group/member/{memberId}" authentication={["api-key"]} title="Remove a single User from a Group by Member Id" headingLevel="h3"/>
...
<API method="DELETE" uri="/api/group/member?groupId={groupId}&userId={userId}" authentication={["api-key"]} title="Remove a single User from a Group by User Id and Group Id" headingLevel="h3"/>
...
<API method="DELETE" uri="/api/group/member?groupId={groupId}" authentication={["api-key"]} title="Remove all Users from a Group" headingLevel="h3"/>
