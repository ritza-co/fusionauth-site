...
<TryInExplorer method="PUT" path="/api/user/consent/{userConsentId}" />

## Request

Send the full User Consent object with your changes applied, identifying it by the Id on the URI.
