...
<TryInExplorer method="GET" path="/api/user/consent" />

## Request

Provide the `userId` query parameter to retrieve all of a User's Consents, or include a User Consent Id on the URI to retrieve a single one.
