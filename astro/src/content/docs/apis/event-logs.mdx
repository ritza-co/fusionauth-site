...
<TryInExplorer method="GET" path="/api/system/event-log/{logId}" tag="system" />

## Retrieve an Event Log

### Request

Retrieve the Event Log by its Id.

<API method="GET" uri="/api/system/event-log/{logId}" authentication={["global-api-key"]} title="Retrieve an Event Log by Id"/>
...
<API method="GET" uri="/api/system/event-log/search?message={message}&start={start}&end={end}&type={type}" authentication={["global-api-key"]} title="Searches the Event Logs using the given search criteria"/>
...
<API method="POST" uri="/api/system/event-log/search" authentication={["global-api-key"]} title="Searches the Event Logs using the given search criteria"/>
