...
Retrieve multi-factor status with a `GET` request using query parameters, or a `POST` request using a JSON body for richer input to MFA requirement lambdas.
