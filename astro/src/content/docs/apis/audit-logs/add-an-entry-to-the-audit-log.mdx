...
<TryInExplorer method="POST" path="/api/system/audit-log" tag="system" />

## Request

Send the message and user responsible for the action in the request body, along with any optional details.
