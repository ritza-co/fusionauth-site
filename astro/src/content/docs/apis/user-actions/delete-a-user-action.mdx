...
<TryInExplorer method="DELETE" path="/api/user-action/{userActionId}" tag="user-actions" />

## Request

Choose a soft delete to deactivate the User Action, or add `hardDelete=true` to permanently remove it.
