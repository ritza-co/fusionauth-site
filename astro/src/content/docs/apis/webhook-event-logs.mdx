...
<TryInExplorer method="GET" path="/api/system/webhook-event-log/{logId}" tag="system" />

## Retrieve a Webhook Event Log

### Request

Retrieve the Webhook Event Log by its Id.

<API method="GET" uri="/api/system/webhook-event-log/{logId}" authentication={["global-api-key"]} title="Retrieve a Webhook Event Log by Id"/>
...
Retrieve the Webhook Attempt Log by its Id.

<API method="GET" uri="/api/system/webhook-attempt-log/{logId}" authentication={["global-api-key"]} title="Retrieve a Webhook Attempt Log by Id"/>
...
Send the search criteria as query parameters on a `GET` request or as a JSON body on a `POST` request.

<API method="GET" uri="/api/system/webhook-event-log/search?event={event}&start={start}&end={end}&eventType={eventType}" authentication={["global-api-key"]} title="Searches the Webhook Event Logs using the given search criteria"/>
...
<API method="POST" uri="/api/system/webhook-event-log/search" authentication={["global-api-key"]} title="Searches the Webhook Event Logs using the given search criteria"/>
