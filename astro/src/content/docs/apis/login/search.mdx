...
This API allows you to search and paginate through the Login Records, useful for auditing, debugging a user's login history, or a security review. Login Records are created in the following scenarios:
...
This API supports two ways to send the search criteria, either as GET parameters or as a request body.
