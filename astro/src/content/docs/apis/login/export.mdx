...
This API is used to export Login Records for offline analysis or long-term archival, the response will be a compressed zip archive of CSV files.

<TryInExplorer method="GET" path="/api/system/login-record/export" tag="system" />

## Request

This API supports two ways to send the export criteria, either as GET parameters or as a request body.
