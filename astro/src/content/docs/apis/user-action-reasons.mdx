...
<TryInExplorer method="POST" path="/api/user-action-reason" tag="user-action-reasons" />
...
Create a User Action Reason with either a randomly generated Id or one you provide on the URI.

<API method="POST" uri="/api/user-action-reason" authentication={["global-api-key"]} title="Create a User Action Reason with a randomly generated Id"/>

<API method="POST" uri="/api/user-action-reason/{userActionReasonId}" authentication={["global-api-key"]} title="Create a User Action Reason with the given Id"/>
...
Retrieve a single User Action Reason by its Id, or leave off the Id to retrieve all of the User Action Reasons.

<API method="GET" uri="/api/user-action-reason" authentication={["global-api-key"]} title="Retrieve all of the User Action Reasons"/>

<API method="GET" uri="/api/user-action-reason/{userActionReasonId}" authentication={["global-api-key"]} title="Retrieve a User Action Reason by Id"/>
...
Update the User Action Reason by sending the fields you want to change.

<API method="PUT" uri="/api/user-action-reason/{userActionReasonId}" authentication={["global-api-key"]} showPatch={true} title="Update the User Action Reason by Id"/>
...
Delete the User Action Reason by its Id.

<API method="DELETE" uri="/api/user-action-reason/{userActionReasonId}" authentication={["global-api-key"]} title="Delete a User Action Reason by Id"/>
