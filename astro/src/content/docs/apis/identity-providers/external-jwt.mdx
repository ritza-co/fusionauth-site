...
Create an External JWT Identity Provider with either a randomly generated Id or one you provide on the URI.
...
Retrieve the External JWT Identity Provider by its Id.
...
Update the External JWT Identity Provider by sending the fields you want to change.
...
Delete the External JWT Identity Provider by its Id.
...
Complete the External JWT login by providing the JWT issued by the external service.
