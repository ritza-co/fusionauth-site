...
<TryInExplorer method="POST" path="/api/form" tag="forms" />
...
Create a Form with either a randomly generated Id or one you provide on the URI.

<API method="POST" uri="/api/form" authentication={["global-api-key"]} title="Create a Form with a randomly generated Id"/>

<API method="POST" uri="/api/form/{formId}" authentication={["global-api-key"]} title="Create a Form with the provided unique Id"/>
...
Retrieve all of the Forms, or provide an Id to retrieve a single Form.

<API method="GET" uri="/api/form" authentication={["global-api-key"]} title="Retrieve all of the Forms"/>

<API method="GET" uri="/api/form/{formId}" authentication={["global-api-key"]} title="Retrieve a Form by Id"/>
...
Update the Form by sending the fields you want to change.

<API method="PUT" uri="/api/form/{formId}" authentication={["global-api-key"]} showPatch={true} title="Update the Form with the given Id"/>
...
<API method="DELETE" uri="/api/form/{formId}" authentication={["global-api-key"]} title="Delete a Form by Id"/>
