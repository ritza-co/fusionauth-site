...
<TryInExplorer method="POST" path="/api/form/field" tag="forms" />
...
Create a Form Field with either a randomly generated Id or one you provide on the URI.

<API method="POST" uri="/api/form/field" authentication={["global-api-key"]} title="Create a Form Field with a randomly generated Id"/>

<API method="POST" uri="/api/form/field/{fieldId}" authentication={["global-api-key"]} title="Create a Form Field with the provided unique Id"/>
...
Retrieve all of the Form Fields, or provide an Id to retrieve a single Form Field.

<API method="GET" uri="/api/form/field" authentication={["global-api-key"]} title="Retrieve all of the Form Fields"/>

<API method="GET" uri="/api/form/field/{fieldId}" authentication={["global-api-key"]} title="Retrieve a Form Field by Id"/>
...
Update the Form Field by sending the fields you want to change.

<API method="PUT" uri="/api/form/field/{fieldId}" authentication={["global-api-key"]} showPatch={true} title="Update the Form Field with the given Id"/>
...
Delete a Form Field by its Id.

<API method="DELETE" uri="/api/form/field/{fieldId}" authentication={["global-api-key"]} title="Delete a Form Field by Id"/>
