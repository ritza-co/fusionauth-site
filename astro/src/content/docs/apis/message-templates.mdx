...
<TryInExplorer method="POST" path="/api/message/template" tag="messages" />
...
Create a Message Template with either a randomly generated Id or one you provide on the URI.

<API method="POST" uri="/api/message/template" authentication={["global-api-key"]} title="Create a Message Template without providing an Id. An Id will be automatically generated."/>

<API method="POST" uri="/api/message/template/{messageTemplateId}" authentication={["global-api-key"]} title="Create a Message Template with the provided Id"/>

#### Request Parameters

<APIBlock>
  <APIField name="messageTemplateId" type="UUID" optional immutable defaults="secure random UUID">
...
Retrieve a single Message Template by its Id, or leave off the Id to retrieve all of the Message Templates.

<API method="GET" uri="/api/message/template" authentication={["global-api-key"]} title="Retrieve all of the Message Templates"/>

<API method="GET" uri="/api/message/template/{messageTemplateId}" authentication={["global-api-key"]} title="Retrieve a single Message Template by Id"/>
...
Update the Message Template by sending the fields you want to change.

<API method="PUT" uri="/api/message/template/{messageTemplateId}" authentication={["global-api-key"]} showPatch={true}  title="Update a Message Template by Id"/>
...
Delete the Message Template by its Id.

<API method="DELETE" uri="/api/message/template/{messageTemplateId}" authentication={["global-api-key"]} title="Delete a Message Template By Id"/>
...
Send the Message Template you want to preview in the request body.

<API method="POST" uri="/api/message/template/preview" authentication={["global-api-key"]} title="Preview a Message Template"/>
