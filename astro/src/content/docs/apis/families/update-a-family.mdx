...
<TryInExplorer method="PUT" path="/api/user/family/{familyId}" />

## Request

Identify the Family member to update using the Family Id on the URI, and provide the new role or owner status in the request body.
