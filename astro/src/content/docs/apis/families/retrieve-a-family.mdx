...
<TryInExplorer method="GET" path="/api/user/family/{familyId}" />

## Request

Retrieve a Family by its Id, or retrieve all of a User's Families by the User's Id.
...
Provide the User's Id on the URI to retrieve all of the Families that User belongs to.
