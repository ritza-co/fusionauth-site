...
<TryInExplorer method="POST" path="/api/tenant" tag="tenants" />

## Request

Create a Tenant with a new set of values, or create a Tenant by copying an existing Tenant.
...
### Create a Tenant from an existing Tenant
