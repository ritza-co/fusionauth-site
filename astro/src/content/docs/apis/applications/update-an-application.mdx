...
<TryInExplorer method="PUT" path="/api/application/{applicationId}" tag="applications" />

## Request

Send the full Application object with your changes applied, identifying it by the Id on the URI.
