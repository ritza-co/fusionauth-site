...
<TryInExplorer method="DELETE" path="/api/application/{applicationId}" tag="applications" />

## Request

Choose a soft delete to deactivate the Application, or add `hardDelete=true` to permanently remove it.
