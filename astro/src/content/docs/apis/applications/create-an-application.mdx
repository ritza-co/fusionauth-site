...
<TryInExplorer method="POST" path="/api/application" tag="applications" />

## Request

Create an Application with a new set of values, or create an Application by copying an existing Application.
