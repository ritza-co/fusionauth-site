...
<TryInExplorer method="GET" path="/api/status" tag="status" />

## Request

Provide an API key to receive the full status and metrics, or omit it to receive a status-only response.
