---
title: Migration From Akamai Identity Cloud
...
https://www.akamai.com/create-account
https://login.linode.com

firefox will not work. brave does.
...
- [Akamai Identity Cloud end of life FAQ](https://techdocs.akamai.com/identity-cloud/docs/product-status)

## TODO

- sign up - https://www.akamai.com/create-account
- delete todo
- use janrain docs to help export if necessary - https://en.wikipedia.org/wiki/Janrain
- brief - https://drafts.cc.ritza.co/s/p7D-5IHAL#
- signup error from uk - https://imgbox.com/bIpPV5vZ