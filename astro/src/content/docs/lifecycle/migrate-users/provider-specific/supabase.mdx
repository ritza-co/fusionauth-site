...
This document will help you migrate from Supabase to FusionAuth.
...
<LocalCode lang="shell" src="import-scripts/supabase/supabase_user_migration_script.sql" title="Supabase user data export function" />
...
![Adding an API key](/img/docs/lifecycle/migrate-users/provider-specific/supabase/supabase-sql.png)
...
[Import User API docs](/docs/apis/users/import). This will require modifying the `import.rb` code.
