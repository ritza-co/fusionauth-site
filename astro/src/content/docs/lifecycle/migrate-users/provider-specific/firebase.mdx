...
<LocalCode lang="shell" title="Adding the scrypt parameters to the plugin" src="contrib/ExampleFirebaseScryptPasswordEncryptor.snippet.scryptParameters[].java" />
