...
you are looking to compare FusionAuth and Firebase Authentication, [this document may help](/blog/firebase-and-fusionauth-ciam-comparison).
...
<LocalCode lang="shell" title="Adding the scrypt parameters to the plugin" src="contrib/Password Hashing Plugins/src/main/java/com/mycompany/fusionauth/plugins/ExampleFirebaseScryptPasswordEncryptor.java.snippet.scryptParameters.java" />
...
![Set hash scheme](/img/docs/lifecycle/migrate-users/provider-specific/firebase/set-hash-scheme.png)
...
are documented in the [Import User API docs](/docs/apis/users/import). This will require modifying the `import.rb` code.
