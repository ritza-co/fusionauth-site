...
<LocalCode lang="java" title="Configuration to change for the example" src="example-scim-integration/ScimExample.snippet.scimConfiguration.java" />
...
<LocalCode lang="java" title="The getCredentials method" src="example-scim-integration/ScimExample.snippet.getCredentials.java" />
...
<LocalCode lang="java" title="The createUser method" src="example-scim-integration/ScimExample.snippet.createUser.java" />
