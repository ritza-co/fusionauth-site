...
```mermaid title="Single sign-on request flow during logout."
sequenceDiagram
    participant Browser
    participant pp as Pied Piper
    participant FusionAuth
...
To walk through this guide, you will need to have FusionAuth and Node installed. For FusionAuth installation instructions, please visit [the 5 minute setup guide](/docs/get-started/start-here/step-1).
...
Next, create and configure the applications in FusionAuth. This guide uses the Admin UI, though you can also do this using the API.
...
Click <Breadcrumb>Save</Breadcrumb> for each application.

View each application by clicking the adjacent <IconButton icon="view" /> in the list of applications and note the `Client Id` and `Client Secret` values:
...
<LocalCode lang="javascript" src="example-node-sso/pied-piper/package.json" title="package.json" />
...
<LocalCode lang="javascript" src="example-node-sso/pied-piper/app.js" title="app.js" />
...
<LocalCode lang="javascript" src="example-node-sso/pied-piper/bin/www" title="bin/www" />
...
<LocalCode lang="properties" src="example-node-sso/pied-piper/.env" title="The .env File" />
...
<LocalCode lang="javascript" src="example-node-sso/pied-piper/routes/index.js" title="routes/index.js" />

This code handles a number of paths. Let's look at the code in more detail.

<LocalCode lang="javascript" src="example-node-sso/pied-piper/routes/index.js.snippet.constants.javascript" title="Constants section" />
...
<LocalCode lang="javascript" src="example-node-sso/pied-piper/routes/index.js.snippet.homepageroute.javascript" title="Home page route" />
...
<LocalCode lang="javascript" src="example-node-sso/pied-piper/routes/index.js.snippet.loginpageroute.javascript" title="Login page route" />
...
<LocalCode lang="javascript" src="example-node-sso/pied-piper/routes/index.js.snippet.logoutpageroute.javascript" title="Logout page route" />
...
<LocalCode lang="javascript" src="example-node-sso/pied-piper/routes/index.js.snippet.endsessionroute.javascript" title="End session route" />
...
<LocalCode lang="javascript" src="example-node-sso/pied-piper/routes/index.js.snippet.oauthredirectroute.javascript" title="OAuth redirect route" />
...
<LocalCode lang="pug" src="example-node-sso/pied-piper/views/layout.pug" title="Layout view" />
...
<LocalCode lang="pug" src="example-node-sso/pied-piper/views/login.pug" title="Login view" />

This is where you'd put information about your application for unauthorized users.

Then, create the index view:

<LocalCode lang="pug" src="example-node-sso/pied-piper/views/index.pug" title="Index view" />
...
<LocalCode lang="pug" src="example-node-sso/hooli/views/layout.pug" title="Index view" />
...
* Check <Breadcrumb>Keep Me Signed In</Breadcrumb>
...
Navigate to <Breadcrumb>Applications -> Your Application -> OAuth</Breadcrumb> and configure **Logout behavior** to have the value `Redirect Only`.
