...
<LocalCode lang="javascript" src="example-javascript-webauthn/base64url-to-buffer.js" title="Function to convert a base64url-encoded string to an ArrayBuffer" />
...
<LocalCode lang="javascript" src="example-javascript-webauthn/buffer-to-base64url.js" title="Function to convert an ArrayBuffer to a base64url-encoded string" />
