...
* Enable WebAuthn under the <Breadcrumb>WebAuthn</Breadcrumb> tab of the tenant configuration:

![Enable WebAuthn](/img/docs/lifecycle/authenticate-users/passwordless/tenant-enable-webauthn.png)

* Enable one or more WebAuthn workflows on the tenant configuration:

![Enable Workflows](/img/docs/lifecycle/authenticate-users/passwordless/tenant-enable-workflows.png)
...
![Re-authentication Prompt](/img/docs/lifecycle/authenticate-users/passwordless/reauth-enable.png)
...
![Passkey Self Service](/img/docs/lifecycle/authenticate-users/passwordless/self-service.png)
...
![Bootstrap Login Button](/img/docs/lifecycle/authenticate-users/passwordless/bootstrap-button.png)
...
![Bootstrap Login Page](/img/docs/lifecycle/authenticate-users/passwordless/bootstrap-login.png)
...
<LocalCode title="Function to convert a base64url-encoded string to an ArrayBuffer" lang="javascript" src="webauthn/base64url-to-buffer.snippet.base64url-to-buffer.js" />
...
<LocalCode lang="javascript" title="Function to convert an ArrayBuffer to a base64url-encoded string" src="webauthn/buffer-to-base64url.snippet.buffer-to-base64url.js" />
...
<LocalCode lang="javascript" src="webauthn/base64url-to-buffer.snippet.base64url-to-buffer.js" />
...
<LocalCode title="Function to convert an ArrayBuffer to a base64url-encoded string" lang="javascript" src="webauthn/buffer-to-base64url.snippet.buffer-to-base64url.js" />
...
![The tenant settings to customize challenge lifetime.](/img/docs/lifecycle/authenticate-users/passwordless/challenge-settings.png)
