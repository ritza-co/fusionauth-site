...
you can get users list of google users with this script - https://github.com/FusionAuth/fusionauth-example-scripts/blob/main/full-user-search/ssostats.sh. there is no place in the FA web interface to see all Google users.

to log out your user go to https://myaccount.google.com/u/1/security

issue where fa stores and doens't return google token - https://github.com/FusionAuth/fusionauth-issues/issues/2574

## Todo

- look in rjeritza/16_.. for todos to continuie this article
- https://drafts.cc.ritza.co/s/CIi3qE_d0#
- log out of google login - https://myaccount.google.com/u/1/security?authuser=1
- google console for testing - https://console.cloud.google.com/apis/credentials/oauthclient/535042435541-eridnie9d09pa69dsq1hh066ushvp4e0.apps.googleusercontent.com?chat=true&project=fago-439308
- read:
  - bug where fa doesn't return access token - https://github.com/FusionAuth/fusionauth-issues/issues/2574
