...
<LocalCode lang="python" src="example-anonymous-user/server.snippet.createFusionAuthClient.py" />
...
<LocalCode lang="python" src="example-anonymous-user/server.snippet.createUser.py" />
...
<LocalCode lang="python" src="example-anonymous-user/server.snippet.createJWT.py" />
...
<LocalCode lang="python" src="example-anonymous-user/server.snippet.readJWT.py" />
...
<LocalCode lang="python" src="example-anonymous-user/server.snippet.getAnonUserIdFromCookie.py" />
...
<LocalCode lang="python" src="example-anonymous-user/server.snippet.registerAnonymousUserRoute.py" />
...
<LocalCode lang="python" src="example-anonymous-user/server.snippet.cleanupAnonymousUserRoute.py" />
