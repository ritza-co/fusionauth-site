...
<LocalCode src="example-get-started/sdk.snippet.logInUser.ts" lang="typescript" />
...
<LocalCode src="example-get-started/sdk.snippet.getUser.ts" lang="typescript" />
...
<LocalCode src="example-get-started/sdk.snippet.handleJWTException.ts" lang="typescript" />
