...
<LocalCode src="example-get-started/account.snippet.logout.html" lang="html"/>

Open the file `src/index.mts` and find the route for `/logout`. This code is simple and delegates to the SDK like this:

<LocalCode src="example-get-started/index.snippet.logout.mts" lang="typescript"/>
...
<LocalCode src="example-get-started/sdk.snippet.sendToLogoutPage.ts" lang="typescript"/>
...
<LocalCode src="example-get-started/index.snippet.oauth2-logout.mts" lang="typescript"/>
...
<LocalCode src="example-get-started/sdk.snippet.handleOAuthLogoutRedirect.ts" lang="typescript"/>
