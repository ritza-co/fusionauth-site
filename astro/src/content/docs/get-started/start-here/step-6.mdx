...
<LocalCode src="example-get-started/templates/account.html.snippet.logout.html" lang="html"/>

Open the file `src/index.mts` and find the route for `/logout`. This code is simple and delegates to the SDK like this:

<LocalCode src="example-get-started/src/index.mts.snippet.logout.mts" lang="typescript"/>
...
<LocalCode src="example-get-started/src/sdk.ts.snippet.sendToLogoutPage.ts" lang="typescript"/>
...
<LocalCode src="example-get-started/src/index.mts.snippet.oauth2-logout.mts" lang="typescript"/>
...
<LocalCode src="example-get-started/src/sdk.ts.snippet.handleOAuthLogoutRedirect.ts" lang="typescript"/>
