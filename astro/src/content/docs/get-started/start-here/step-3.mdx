...
<LocalCode src="example-get-started/src/index.mts.snippet.account.mts" lang="typescript" />
...
<LocalCode src="example-get-started/src/sdk.ts.snippet.userHasAccess.ts" lang="typescript" />
