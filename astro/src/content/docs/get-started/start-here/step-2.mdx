...
<LocalCode src="example-get-started/templates/home.html.snippet.login.html" lang="html" />
...
<LocalCode src="example-get-started/src/index.mts.snippet.login.mts" lang="typescript" />
