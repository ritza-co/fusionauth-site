...
<LocalCode src="example-get-started/example.snippet.fa-has-title.ts" lang="typescript"/>
...
<LocalCode src="example-get-started/example.snippet.log-in.ts" lang="typescript"/>
