...
<LocalCode src="example-get-started/example.spec.snippet.fa-has-title.ts" lang="typescript"/>
...
<LocalCode src="example-get-started/example.spec.snippet.log-in.ts" lang="typescript"/>
