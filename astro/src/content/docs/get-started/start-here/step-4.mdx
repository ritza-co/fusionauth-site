...
<LocalCode src="example-get-started/index.snippet.account.mts" lang="typescript" />
...
<LocalCode src="example-get-started/index.snippet.admin.mts" lang="typescript" />
...
<LocalCode src="example-get-started/sdk.snippet.userHasAccess.ts" lang="typescript" />
