...
<LocalCode src="example-get-started/src/index.snippet.account.mts" lang="typescript" />
...
<LocalCode src="example-get-started/src/index.snippet.admin.mts" lang="typescript" />
...
<LocalCode src="example-get-started/src/sdk.snippet.userHasAccess.ts" lang="typescript" />
