...
order: 6
tags: docker, kubernetes, k8s, container, aks, eks, gke
---
...
![title=FusionAuth and Kubernetes architecture overview](/img/docs/get-started/download-and-install/kubernetes/kubernetes-arch-overview.png)
...
<LocalCode src="contrib/kubernetes/istio/fusionauth-all-in-one.yaml" lang="yaml" />
