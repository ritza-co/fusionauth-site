---
title: Customize Docker Images
description: Learn how to configure a Docker image containing FusionAuth to meet the needs of your application.
---
...
<LocalCode title="Example Dockerfile for building fusionauth-app including a plugin" src="example-docker-compose/build/fusionauth-app/Dockerfile" lang="docker" />

Here's an example docker compose YAML file which uses this new image:

<LocalCode title="Example docker-compose.yml for building fusionauth-app including a plugin" src="example-docker-compose/build/docker-compose.yml" lang="yaml" />
...
<LocalCode title="The FusionAuth Docker file" src="containers/docker/fusionauth/fusionauth-app/Dockerfile" lang="docker" />

For more FusionAuth Docker images, see [fusionauth on Docker Hub](https://hub.docker.com/u/fusionauth/). For an in-depth example, see the [FusionAuth Docker Compose example repository](https://github.com/FusionAuth/fusionauth-example-docker-compose). For OpenShift and other community-supported environments, see the [FusionAuth Contrib](https://github.com/FusionAuth/fusionauth-contrib) GitHub repo.
...
<LocalCode title="Example docker-compose.yml for running Kickstart" src="example-docker-compose/kickstart/docker-compose.yml" lang="yaml" />
...
```shell-session title="Delete the volumes"
...
<LocalCode title="Example docker-compose.yml for installing a plugin" src="example-docker-compose/plugin/docker-compose.yml" lang="yaml" />
...
<LocalCode title="Example docker-compose.yml with mailcatcher" src="example-docker-compose/mailcatcher/docker-compose.yml" lang="yaml" />
...
<LocalCode title="Example Dockerfile which downloads the MySQL connector" lang="docker" src="containers/docker/fusionauth/fusionauth-app-mysql/Dockerfile" />
