...
`server.py`
<LocalCode src="quickstart-python-flask-web/server.snippet.baseApplication.py" lang="python" />
...
`server.py`
<LocalCode src="quickstart-python-flask-web/server.snippet.homeRoute.py" lang="python" />
...
`server.py`
<LocalCode src="quickstart-python-flask-web/server.snippet.loginRoute.py" lang="python" />

<LocalCode src="quickstart-python-flask-web/server.snippet.callbackRoute.py" lang="python" />
...
<LocalCode src="quickstart-python-flask-web/server.snippet.accountRoute.py" lang="python" />
...
<LocalCode src="quickstart-python-flask-web/server.snippet.logoutRoute.py" lang="python" />
