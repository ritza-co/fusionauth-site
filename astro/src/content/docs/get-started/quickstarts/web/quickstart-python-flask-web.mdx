...
htmlTitle: FusionAuth QuickStart for Python Flask
...
<Intro technology="Python and Flask"
...
`requirements.txt`
<LocalCode src="quickstart-python-flask-web/complete-application/requirements.txt" lang="python" />
...
`.env`
<LocalCode src="quickstart-python-flask-web/complete-application/.env" lang="ini" />

In `server.py`, you'll add all of the imports you'll need, declare some constants, and initialize the OAuth library.

`server.py`
<LocalCode src="quickstart-python-flask-web/complete-application/server.py.snippet.baseApplication.py" lang="python" />
...
`server.py`
<LocalCode src="quickstart-python-flask-web/complete-application/server.py.snippet.homeRoute.py" lang="python" />
...
`server.py`
<LocalCode src="quickstart-python-flask-web/complete-application/server.py.snippet.loginRoute.py" lang="python" />

<LocalCode src="quickstart-python-flask-web/complete-application/server.py.snippet.callbackRoute.py" lang="python" />
...
<LocalCode src="quickstart-python-flask-web/complete-application/server.py.snippet.accountRoute.py" lang="python" />
...
<LocalCode src="quickstart-python-flask-web/complete-application/server.py.snippet.logoutRoute.py" lang="python" />

<Aside type="tip">
Click the <Breadcrumb>Logout</Breadcrumb> button and watch the browser first go to FusionAuth to log out the user, then return to your home page.
</Aside>
