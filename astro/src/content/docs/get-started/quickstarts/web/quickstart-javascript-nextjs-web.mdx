...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/src/app/api/auth/[...nextauth]/route.ts"}  lang="ts" />
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/src/app/globals.css"}  lang="ts" />
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/src/components/LoginButton.tsx"}  lang="ts" />
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/src/components/LoginLink.tsx"}  lang="ts" />
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/src/app/layout.tsx"}  lang="ts" />
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/src/app/page.tsx"}  lang="ts" />
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/src/app/account/page.tsx"}  lang="ts" />
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/src/app/makechange/page.tsx"}  lang="ts" />
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/src/components/MakeChangeForm.tsx"}  lang="ts" />
