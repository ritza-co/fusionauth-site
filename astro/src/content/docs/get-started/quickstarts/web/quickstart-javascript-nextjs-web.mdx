...
htmlTitle: FusionAuth QuickStart for Next.js
...
<ExtractedCode src="fusionauth-quickstart-javascript-nextjs-web/complete-application/src/app/api/auth/[...nextauth]/route.ts" lang="ts" />
...
<ExtractedCode src="fusionauth-quickstart-javascript-nextjs-web/complete-application/src/app/globals.css" lang="css" />
...
<ExtractedCode src="fusionauth-quickstart-javascript-nextjs-web/complete-application/src/components/LoginButton.tsx" lang="tsx" />
...
<ExtractedCode src="fusionauth-quickstart-javascript-nextjs-web/complete-application/src/components/LoginLink.tsx" lang="tsx" />
...
<ExtractedCode src="fusionauth-quickstart-javascript-nextjs-web/complete-application/src/app/layout.tsx" lang="tsx" />

### Home Page

Create a new file `src/app/page.tsx` which will have the Homepage details. Not much here just an image and another <Breadcrumb>Login</Breadcrumb> button.

<ExtractedCode src="fusionauth-quickstart-javascript-nextjs-web/complete-application/src/app/page.tsx" lang="tsx" />
...
<ExtractedCode src="fusionauth-quickstart-javascript-nextjs-web/complete-application/src/app/account/page.tsx" lang="tsx" />
...
<ExtractedCode src="fusionauth-quickstart-javascript-nextjs-web/complete-application/src/app/makechange/page.tsx" lang="tsx" />
...
<ExtractedCode src="fusionauth-quickstart-javascript-nextjs-web/complete-application/src/components/MakeChangeForm.tsx" lang="tsx" />
...
Try clicking the <Breadcrumb>Login</Breadcrumb> button at the top or center of the screen.
