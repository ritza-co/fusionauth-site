...
This app has been tested with Ruby 4.0.5 and Rails 7.1.6. This example should work with other compatible versions of Ruby and Rails.
...
<LocalCode src="fusionauth-quickstart-ruby-on-rails-web/Gemfile.snippet.gemfile"
 lang="ruby"/>
...
<LocalCode src="fusionauth-quickstart-ruby-on-rails-web/development.snippet.oidcConfig.rb"
lang="ruby"/>

Configure OmniAuth by creating `config/initializers/omniauth.rb` with the following code:

<LocalCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/config/initializers/omniauth.rb"
lang="ruby" />
...
<LocalCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/config/routes.rb"
lang="ruby" />
...
<LocalCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/app/controllers/auth_controller.rb"
lang="ruby" />
...
<LocalCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/app/controllers/application_controller.rb"
lang="ruby" />
...
<LocalCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/app/controllers/home_controller.rb"
lang="ruby" />
...
<LocalCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/app/controllers/make_change_controller.rb"
lang="ruby" />
...
<LocalCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/app/views/home/index.html.erb"
lang="erb" />
...
<LocalCode src="fusionauth-quickstart-ruby-on-rails-web/application.html.snippet.applicationLayout.erb"
lang="erb"/>

Finally, add a form and messaging for making change at `app/views/make_change/index.html.erb`:

<LocalCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/app/views/make_change/index.html.erb"
lang="erb" />
...
Ensure FusionAuth is running in the Docker container.  You should be able to login as the admin user, <code><LocalValue path="fusionauth-quickstart-ruby-on-rails-web/kickstart/kickstart.json" selector="$.variables.adminEmail" /></code> with a password of <code><LocalValue path="fusionauth-quickstart-ruby-on-rails-web/kickstart/kickstart.json" selector="$.variables.adminPassword" /></code> at [http://localhost:9011/admin](http://localhost:9011/admin).

* I get an error page when I click on the <Breadcrumb>Login</Breadcrumb> button with message of `"error_reason" : "invalid_client_id"`
