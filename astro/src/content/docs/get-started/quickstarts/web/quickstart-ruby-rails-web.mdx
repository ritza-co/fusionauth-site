...
htmlTitle: FusionAuth QuickStart for Ruby on Rails
...
<ExtractedCode src="fusionauth-quickstart-ruby-on-rails-web/Gemfile.snippet.gemfile"
 lang="ruby"/>
...
<ExtractedCode src="fusionauth-quickstart-ruby-on-rails-web/development.snippet.oidcConfig.rb"
lang="ruby"/>

Configure OmniAuth by creating `config/initializers/omniauth.rb` with the following code:

<ExtractedCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/config/initializers/omniauth.rb"
lang="ruby" />
...
<ExtractedCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/config/routes.rb"
lang="ruby" />
...
<ExtractedCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/app/controllers/auth_controller.rb"
lang="ruby" />
...
<ExtractedCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/app/controllers/application_controller.rb"
lang="ruby" />
...
<ExtractedCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/app/controllers/home_controller.rb"
lang="ruby" />
...
<ExtractedCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/app/controllers/make_change_controller.rb"
lang="ruby" />
...
<ExtractedCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/app/views/home/index.html.erb"
lang="erb" />
...
<ExtractedCode src="fusionauth-quickstart-ruby-on-rails-web/application.html.snippet.applicationLayout.erb"
lang="erb"/>

Finally, add a form and messaging for making change at `app/views/make_change/index.html.erb`:

<ExtractedCode src="fusionauth-quickstart-ruby-on-rails-web/complete-app/app/views/make_change/index.html.erb"
lang="erb" />
...
Ensure FusionAuth is running in the Docker container. You should be able to log in as `admin@example.com` with the password `password` at [http://localhost:9011/admin](http://localhost:9011/admin).
