...
<LocalCode src="quickstart-php-laravel-api/complete-application/database/migrations/2014_10_12_000000_create_users_table.php" lang="php"/>
...
<LocalCode src="quickstart-php-laravel-api/.env.snippet.fusionauth" lang="ini"/>
