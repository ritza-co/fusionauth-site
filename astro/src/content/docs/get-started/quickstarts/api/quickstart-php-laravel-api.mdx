...
This file logs and displays authentication errors in detail to help you debug any authentication problems you might encounter. You may want to return less detail in error messages when moving to a production system to hide information from hackers.
