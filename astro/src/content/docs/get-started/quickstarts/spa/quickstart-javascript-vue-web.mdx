...
<LocalCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/main.ts" lang="typescript"/>
...
<LocalCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/views/HomeView.vue" lang="vue"/>

#### Create An Account Page

The account page displays a random balance for the logged in user. Create a new file `src/views/AccountView.vue`:

<LocalCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/views/AccountView.vue" lang="vue"/>
...
<LocalCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/views/MakeChangeView.vue" lang="vue"/>
...
<LocalCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/components/LogoHeader.vue" lang="vue"/>

Additionally, we want to display different menu items. For this create a new file `src/components/MenuBar.vue`:

<LocalCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/components/MenuBar.vue" lang="vue"/>
...
<LocalCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/App.vue" lang="vue"/>

And finally we register the routes in `src/router/index.ts`. Update that file with the code below.

<LocalCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/router/index.ts" lang="typescript"/>
