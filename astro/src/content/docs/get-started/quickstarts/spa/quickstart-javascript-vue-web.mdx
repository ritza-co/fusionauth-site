...
htmlTitle: FusionAuth QuickStart for Vue.js
...
<ExtractedCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/main.ts" lang="typescript"/>
...
<ExtractedCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/views/HomeView.vue" lang="markup"/>

#### Create An Account Page

The account page displays a random balance for the logged in user. Create a new file `src/views/AccountView.vue`:

<ExtractedCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/views/AccountView.vue" lang="markup"/>
...
<ExtractedCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/views/MakeChangeView.vue" lang="markup"/>
...
<ExtractedCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/components/LogoHeader.vue" lang="markup"/>

Additionally, we want to display different menu items. For this create a new file `src/components/MenuBar.vue`:

<ExtractedCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/components/MenuBar.vue" lang="markup"/>
...
<ExtractedCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/App.vue" lang="markup"/>

And finally we register the routes in `src/router/index.ts`. Update that file with the code below.

<ExtractedCode src="fusionauth-quickstart-javascript-vue-web/complete-application/src/router/index.ts" lang="typescript"/>
