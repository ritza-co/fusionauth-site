...
<LocalCode src="quickstart-javascript-angular-web/complete-application/src/app/app.module.snippet.fusionAuthModuleConfiguration.ts" lang="typescript"/>

Don't forget to import the `FusionAuthModule` at the top of the file.

<LocalCode src="quickstart-javascript-angular-web/complete-application/src/app/app.module.snippet.importAngularSDK.ts" lang="typescript"/>
...
<LocalCode src="quickstart-javascript-angular-web/complete-application/src/app/app.module.snippet.routerConfiguration.ts" lang="typescript"/>

Don't forget to import the `RouterModule` and `authGuard` at the top of the file.

<LocalCode src="quickstart-javascript-angular-web/complete-application/src/app/app.module.snippet.importAuthGuard.ts" lang="typescript"/>
