...
This app has been tested with Node v26 and Angular v22.1.7. This example should work with other compatible versions of Node and Angular.
...
Next, you'll need to configure the SDK with your FusionAuth URL and Client Id. Overwrite the  `src/app/app.config.ts` file inside to add FusionAuth support:

TODO change below to app.config.ts, no tags needed
<LocalCode src="quickstart-javascript-angular-web/app.module.snippet.fusionAuthModuleConfiguration.ts" lang="typescript"/>
...
todo remove component word
<LocalCode src="quickstart-javascript-angular-web/complete-application/src/app/home-page/home-page.component.html" lang="html"/>

And the login function to the component `src/app/home-page/home-page.ts`. Update that file to look like this:

todo remove component word
<LocalCode src="quickstart-javascript-angular-web/complete-application/src/app/home-page/home-page.component.ts" lang="typescript"/>
...
todo remove component word
<LocalCode src="quickstart-javascript-angular-web/complete-application/src/app/account-page/account-page.component.html" lang="html"/>
...
todo remove component word
<LocalCode src="quickstart-javascript-angular-web/complete-application/src/app/account-page/account-page.component.ts" lang="typescript"/>
...
todo remove component word
<LocalCode src="quickstart-javascript-angular-web/complete-application/src/app/make-change-page/make-change-page.component.html" lang="html"/>
...
todo remove component word
<LocalCode src="quickstart-javascript-angular-web/complete-application/src/app/make-change-page/make-change-page.component.ts" lang="typescript"/>
...
Next, you'll need to add the Auth Guard to the routing configuration. Open the `src/app/app.routes.ts` file and add the RouterModule with the following routes inside the `imports: [ ]` part:

todo no snippet .change filename
<LocalCode src="quickstart-javascript-angular-web/app.module.snippet.routerConfiguration.ts" lang="typescript"/>
...
todo remove component word
<LocalCode src="quickstart-javascript-angular-web/complete-application/src/app/app.component.html" lang="html"/>

Finally, open the `src/app/app.ts` file and replace it with the following:

todo remove component word
<LocalCode src="quickstart-javascript-angular-web/complete-application/src/app/app.component.ts" lang="typescript"/>
