...
<LocalCode src="quickstart-javascript-angular-web/app.module.snippet.importAngularSDK.ts" lang="typescript"/>
...
<LocalCode src="quickstart-javascript-angular-web/app.module.snippet.importAuthGuard.ts" lang="typescript"/>
