...
<LocalCode src="quickstart-flutter-native/build.snippet.appAuthRedirectScheme.gradle" lang="text" />
...
<LocalCode src="quickstart-flutter-native/pubspec.snippet.addAsset.yaml" lang="yaml" />
