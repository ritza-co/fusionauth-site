...
htmlTitle: FusionAuth QuickStart for Flutter
...
<LocalCode src="quickstart-flutter-native/complete-application/android/app/build.gradle.snippet.appAuthRedirectScheme.gradle" lang="text" />
...
<LocalCode src="quickstart-flutter-native/complete-application/ios/Runner/Info.plist" lang="xml" />
...
<LocalCode src="quickstart-flutter-native/complete-application/lib/main.dart" lang="dart" />
...
<LocalCode src="quickstart-flutter-native/complete-application/pubspec.yaml.snippet.addAsset.yaml" lang="yaml" />
