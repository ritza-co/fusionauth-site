---
title: Android Kotlin - Fusionauth SDK
description: QuickStart integration of a Kotlin-based Android app with FusionAuth Android SDK.
htmlTitle: FusionAuth QuickStart for Android Kotlin - Fusionauth SDK
...
<LocalMarkdown src="quickstart-kotlin-android-native/README.snippet.forDocSitePrerequisites.md" />
...
Open Android Studio and select `New Project`. Choose `No Activity` and click <Breadcrumb>Next</Breadcrumb>.
...
Click <Breadcrumb>Finish</Breadcrumb>.
...
<LocalCode src="quickstart-kotlin-android-native/complete-application/app/build.gradle.kts" lang="kotlin" />

Replace `app/src/main/AndroidManifest.xml` as well which defines all Activities used later.

<LocalCode src="quickstart-kotlin-android-native/complete-application/app/src/main/AndroidManifest.xml" lang="xml" />
...
<LocalCode src="quickstart-kotlin-android-native/complete-application/app/src/main/res/raw/fusionauth_config.json" lang="json" />
...
<LocalCode src="quickstart-kotlin-android-native/complete-application/app/src/main/res/layout/activity_login.xml" lang="xml" />

Now modify login activity logic by creating `app/src/main/java/io/fusionauth/sdk/LoginActivity.kt` with this code.

<LocalCode src="quickstart-kotlin-android-native/complete-application/app/src/main/java/io/fusionauth/sdk/LoginActivity.kt" lang="kotlin" />

Create the main screen layout in the file `app/src/main/res/layout/activity_token.xml`.

<LocalCode src="quickstart-kotlin-android-native/complete-application/app/src/main/res/layout/activity_token.xml" lang="xml" />

And finally, create the main screen logic by creating `app/src/main/java/io/fusionauth/sdk/TokenActivity.kt` with the below.

<LocalCode src="quickstart-kotlin-android-native/complete-application/app/src/main/java/io/fusionauth/sdk/TokenActivity.kt" lang="kotlin" />
...
<LocalCode src="quickstart-kotlin-android-native/complete-application/app/src/main/res/values/colors.xml" lang="xml" />

Modify strings shown in the user interface by updating `app/src/main/res/values/strings.xml`.

<LocalCode src="quickstart-kotlin-android-native/complete-application/app/src/main/res/values/strings.xml" lang="xml" />

Update the theme in `app/src/main/res/values/themes.xml`.

<LocalCode src="quickstart-kotlin-android-native/complete-application/app/src/main/res/values/themes.xml" lang="xml" />

Create the dimension file in `app/src/main/res/values/dimens.xml`.

<LocalCode src="quickstart-kotlin-android-native/complete-application/app/src/main/res/values/dimens.xml" lang="xml" />
