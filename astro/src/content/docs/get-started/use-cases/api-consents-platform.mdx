...
<LocalCode lang="javascript" src="example-api-consents-platform/index.snippet.routes.js" title="Example Changebank API routes" />

The `hasScope` method looks like this:

<LocalCode lang="javascript" src="example-api-consents-platform/hasScope.snippet.hasScope.js" title="The hasScope logic" />
...
<LocalCode lang="javascript" src="example-api-consents-platform/create-application.snippet.createApplication.js" title="Using the TypeScript SDK to create the application" />

Here's sample code to add needed scopes:

<LocalCode lang="javascript" src="example-api-consents-platform/create-application.snippet.createScopes.js" title="Using the TypeScript SDK to create the application" />
