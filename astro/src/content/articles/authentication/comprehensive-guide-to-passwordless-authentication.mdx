...
![Add passkey to existing user](/img/articles/authentication/comprehensive-guide-to-passwordless/addPasskey.webp)
...
```sh
curl 'http://localhost:9011/api/two-factor/send/2dbCuVDHCUOHexFIJDxR5boIKj2o3wJnc8Co2LkxaLo' \
-H 'Authorization: 33052c8a-c283-4e96-9d2a-eb1215c69f8f-not-for-prod' \
-H 'Content-Type: application/json' \
-d '{
  "methodId": "email"
...
![Step up authentication email](/img/articles/authentication/comprehensive-guide-to-passwordless/stepup.webp)
