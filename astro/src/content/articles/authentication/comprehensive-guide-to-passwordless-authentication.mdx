...
As you probably noticed, your user still had to enter a password at registration. This is because FA doesn't yet offer a fully passwordless user experience. There was a [Github issue](https://github.com/FusionAuth/fusionauth-issues/issues/484) opened for this feature in 2020. If avoiding passwords entirely is important to you, please vote and comment on this issue to increase its priority for the FA programmers.
