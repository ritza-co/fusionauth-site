...
Let's take a quick look at what an API call would look like for an OTP or passkey authentication request from your website to FA.
...
Tatenda: firefox, screenshots, alter email in databsae
