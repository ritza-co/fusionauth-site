...
![Enable passwordless](../../../../public/img/articles/authentication/comprehensive-guide-to-passwordless/enablePasswordless.webp)

![Template](../../../../public/img/articles/authentication/comprehensive-guide-to-passwordless/template.webp)


You need to have email templates enabled for the tenant for magic links to work. Customizations -> Email templates -> Match all functions to the correspondingly named template

Set the email template in the application settings and save.

Add a user. Add registration for Changebank.

View the application - click the OAuth login URL - http://localhost:9011/oauth2/authorize?client_id=e9fdb985-9173-4e01-9d73-ac2d60d1dc8e&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fauth%2Fcallback

![magicLogin](../../../../public/img/articles/authentication/comprehensive-guide-to-passwordless/magicLogin.webp)
...
- passkeys dont' work in linux. security conscious. programmers and IT professionals. so don't force only passkeys. bitwarden extension or yubikey.
