...
While you can code authentication yourself, it's much safer and faster to use a dedicated authentication tool or framework. This section will show you examples of authentication using a tool called FusionAuth, but you can use similar configuration using other software like Ory, Keycloak, Auth0, and others.
...
In the <Breadcrumb>Users</Breadcrumb> page you can add a new user with an email address, and then add the user to the example Changebank application (this is called a "registration" from the user to the application).