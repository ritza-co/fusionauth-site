...
For public websites you should always use magic links instead of passwords. There's almost no reason not to.

unless you are managing a system that does not you should allow users to choose how they would like to authenticate. A technical user might appreciate using passkeys
