...
<LocalCode src="example-ruby-on-rails-custom-scopes/fusionauth-quickstart-ruby-on-rails-api-modifications/app/controllers/get_balance_controller.rb" lang="ruby" />
