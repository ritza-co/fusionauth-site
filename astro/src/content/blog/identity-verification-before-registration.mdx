...
* an admin user with an email of "admin@example.com" and a password of "password"
...
Open up the [admin UI](http://localhost:9011). Use an incognito window or a different browser than you used to test the registration process. Log in as the admin user, with an email of "admin@example.com" and a password of "password".
