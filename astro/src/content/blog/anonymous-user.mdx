...
<LocalCode src="example-anonymous-user/server.snippet.createJWT.py" lang="python" />
...
<LocalCode src="example-anonymous-user/server.snippet.registerAnonymousUserRoute.py" lang="python" />
...
<LocalCode src="example-anonymous-user/server.snippet.cleanupAnonymousUserRoute.py" lang="python" />
