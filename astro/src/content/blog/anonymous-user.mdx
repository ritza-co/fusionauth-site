...
<LocalCode src="example-anonymous-user/complete-application/server.py.snippet.createJWT.py" lang="python" />
...
<LocalCode src="example-anonymous-user/complete-application/server.py.snippet.registerAnonymousUserRoute.py" lang="python" />
...
<LocalCode src="example-anonymous-user/complete-application/server.py.snippet.cleanupAnonymousUserRoute.py" lang="python" />
