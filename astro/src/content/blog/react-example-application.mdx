...
<LocalCode src="example-react-fusiondesk/server/src/middlewares/fusion-auth.middleware.ts" lang="typescript" />
...
<LocalCode src="example-react-fusiondesk/client/src/components/LoggedInMenu.tsx" lang="tsx" />
...
<LocalCode src="example-react-fusiondesk/client/src/components/ProtectedRoutes.tsx" lang="tsx" />
...
<LocalCode src="example-react-fusiondesk/client/src/pages/LoginPage.tsx" lang="tsx" />
...
<LocalCode src="example-react-fusiondesk/server/src/controllers/rest/ticket/FindAllTicketsController.ts" lang="typescript" />

Here's the frontend `TicketsPage.tsx` which ingests the API response and builds a nice looking ticket list:

<LocalCode src="example-react-fusiondesk/client/src/pages/TicketsPage.tsx" lang="tsx" />
...
<LocalCode src="example-react-fusiondesk/server/src/controllers/rest/ticket/FindTicketController.ts" lang="typescript" />

Here's the corresponding create API, using the `POST` method:

<LocalCode src="example-react-fusiondesk/server/src/controllers/rest/ticket/CreateTicketController.ts" lang="typescript" />

Here's the method to update a ticket with `PATCH`:

<LocalCode src="example-react-fusiondesk/server/src/controllers/rest/ticket/UpdateTicketController.ts" lang="typescript" />

Finally, here's the front end code for building the display.

<LocalCode src="example-react-fusiondesk/client/src/pages/TicketPage.tsx" lang="tsx" />
...
<LocalCode src="example-react-fusiondesk/client/src/pages/ProfilePage.tsx" lang="tsx" />
