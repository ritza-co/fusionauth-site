...
Click the <Breadcrumb>Save</Breadcrumb> button in the top right to save these changes. Your setup should look similar to this:
...
Click <Breadcrumb>Generate</Breadcrumb>. A zip file of the project should automatically be downloaded to your local machine. Copy and unzip it to a folder.
...
{/*
<LocalCode src="example-java-spring/src/main/resources/application.properties" lang="java" />
*/}
...
{/*
<LocalCode src="example-java-spring/src/main/java/io/fusionauth/example/spring/config/SecurityConfiguration.java" lang="java" />
*/}
...
{/*
<LocalCode src="example-java-spring/src/main/java/io/fusionauth/example/spring/HomeController.java" lang="java" />
*/}
...
{/*
<LocalCode src="example-java-spring/src/main/resources/templates/home.html" lang="html" />
*/}
...
{/*
<LocalCode src="example-java-spring/src/main/java/io/fusionauth/example/spring/UserController.java" lang="java" />
*/}
...
{/*
<LocalCode src="example-java-spring/src/main/resources/templates/user.html" lang="html" />
*/}
...
Clicking the <Breadcrumb>Create an account</Breadcrumb> link should direct you to the register page to create an account.
