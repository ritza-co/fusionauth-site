...
<LocalCode src="example-hostedbackend/nodeApp/index.html" lang="html" />
...
<LocalCode src="example-hostedbackend/nodeApp/app.js" lang="js" />
...
<LocalCode src="example-hostedbackend/nodeApp/authentication.js" lang="js" />
...
- With the existing Angular, React or Vue SDK for FusionAuth. FusionAuth provides a tutorial and example repository that show [how to integrate authentication into your Angular app](/docs/get-started/quickstarts/spa/quickstart-javascript-angular-web), [how to integrate authentication into your React app](/docs/get-started/quickstarts/spa/react), or [how to integrate authentication into your Vue app](/docs/get-started/quickstarts/spa/quickstart-javascript-vue-web).
...
Browse to the <Breadcrumb>Applications</Breadcrumb> tab of FusionAuth at http://localhost:9011/admin/application. For the `Example App`, click <Breadcrumb>Select -> Edit</Breadcrumb>. On the <Breadcrumb>Scopes</Breadcrumb> tab, change **Scope handling policy** to <Breadcrumb>Compatibility</Breadcrumb>. If you leave this value on <Breadcrumb>Strict</Breadcrumb>, the user's email won't be returned pending resolution of this [issue](https://github.com/FusionAuth/fusionauth-issues/issues/3054).
...
<LocalCode src="example-hostedbackend/serverlessApp/index.html" lang="html" />
...
- [FusionAuth React tutorial for the hosted backend](/docs/get-started/quickstarts/spa/react)
