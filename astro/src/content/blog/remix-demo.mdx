...
Next, create a user and an application in FusionAuth, since that is going to be your user data store. Navigate to `http://localhost:9011` and go through the [setup wizard](/docs/get-started/download-and-install/setup) to create your first user.

Next, create an application in FusionAuth. The application represents the Remix application in FusionAuth. You can learn more about [users](/docs/get-started/core-concepts/types/users) and [applications](/docs/get-started/core-concepts/types/applications). 
...
* Enable the <Breadcrumb>Authorization Code grant</Breadcrumb>
...
<LocalCode src="example-remix/app/routes/login.tsx" lang="typescript" />
...
<LocalCode src="example-remix/app/routes/auth.callback.tsx" lang="typescript" />
