...
<LocalCode src="example-dotnet-windowsform-api/sourcecode/FusionDemoAPI/Helper/User.cs" lang="csharp" />

### Taking Input From The User
Next, you need to take the input from the user and assign them to the values in your User object. In this case, you are performing those actions on a click event from the <Breadcrumb>Create User</Breadcrumb> button on a [Windows Form](https://learn.microsoft.com/en-us/visualstudio/ide/create-csharp-winform-visual-studio?view=vs-2022). Pictured below is a screen shot of the interface for the sample application.
...
It is important to note that the `FusionAuthClient` that has been created for this applications handles the setting of the [API Key](/docs/apis/api-keys) and location of the FusionAuth server. These settings are stored in the `App.settings` file for the project.

<LocalCode src="example-dotnet-windowsform-api/sourcecode/FusionAuthAPIDemoFrontEnd/frmMain.cs.snippet.btnCreateUser.cs" lang="csharp" />
...
<LocalCode src="example-dotnet-windowsform-api/sourcecode/FusionDemoAPI/FusionAuthClient.cs.snippet.CreateUser.cs" lang="csharp" />
...
<LocalCode src="example-dotnet-windowsform-api/sourcecode/FusionDemoAPI/Helper/Group.cs" lang="csharp" />
...
<LocalCode src="example-dotnet-windowsform-api/sourcecode/FusionAuthAPIDemoFrontEnd/frmMain.cs.snippet.btnAddUserToGroup.cs" lang="csharp" />
...
<LocalCode src="example-dotnet-windowsform-api/sourcecode/FusionDemoAPI/FusionAuthClient.cs.snippet.AddUserToGroup.cs" lang="csharp" />
...
## Conclusion
It is important to note that as an alternative, FusionAuth does allow the creation of [custom forms](/docs/get-started/core-concepts/types/tenants#form-settings) in the admin user interface. This solution is only available for paid plans, may not support the workflow you are trying to accomplish and would not work if you did not want to give users access to the FusionAuth admin interface.
...
* [Create a User](/docs/apis/users/create)
* [Delete a User](/docs/apis/users/delete)
* [Add Users to a Group](/docs/apis/groups/add-users-to-a-group)

### FusionAuth Server Setup

* [5-Minute Setup Guide](/docs/get-started/start-here/step-1)
