...
<LocalCode src="example-using-links-fastify/complete-application/src/utils.ts" lang="typescript" />
...
<LocalCode src="example-using-links-fastify/complete-application/src/plugins/view.ts" lang="typescript" />
...
<LocalCode src="example-using-links-fastify/complete-application/templates/_layout.ejs" lang="html" />
...
<LocalCode src="example-using-links-fastify/complete-application/templates/root.ejs" lang="html" />
...
<LocalCode src="example-using-links-fastify/complete-application/templates/login.ejs" lang="html" />
...
<LocalCode src="example-using-links-fastify/complete-application/src/routes/root.ts" lang="typescript" />
...
<LocalCode src="example-using-links-fastify/complete-application/src/plugins/auth.ts" lang="typescript" />
...
<LocalCode src="example-using-links-fastify/complete-application/src/routes/auth.ts" lang="typescript" />
...
<LocalCode src="example-using-links-fastify/complete-application/src/plugins/multipart.ts" lang="typescript" />
...
<LocalCode src="example-using-links-fastify/complete-application/src/routes/upload.ts" lang="typescript" />
...
<LocalCode src="example-using-links-fastify/complete-application/src/links/youtube.ts" lang="typescript" />
...
<LocalCode src="example-using-links-fastify/complete-application/src/links/twitter.ts" lang="typescript" />

#### Stitching It All Together

Create a new file in the `src/links` directory called `index.ts` and add the following code:

<LocalCode src="example-using-links-fastify/complete-application/src/links/index.ts" lang="typescript" />
...
<LocalCode src="example-using-links-fastify/complete-application/src/routes/links.ts" lang="typescript" />
