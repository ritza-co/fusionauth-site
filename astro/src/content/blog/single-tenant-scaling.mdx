...
- [What Is A Multi-Tenant Architecture?](#what-is-a-multi-tenant-architecture)
- [Further Reading](#further-reading)
- [Todo](#todo)

## Introduction

This short article will explain exactly what multi-tenancy is, its benefits, and why you should still choose a single-tenant solution in most cases.
