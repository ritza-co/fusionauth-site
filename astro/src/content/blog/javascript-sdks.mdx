...
Pretty much anything which can use OpenID Connect (OIDC), Security Assertion Markup Language (SAML), or an HTTP based API should work. You can see our [list of quickstarts](/docs/get-started/quickstarts/) for integration examples.
...
The [FusionAuth SPA quickstarts](/docs/get-started/quickstarts/spa/) use SDKs when available. Let's look at some code from these sample integrations:

Here's a component from the [Angular quickstart](/docs/get-started/quickstarts/spa/quickstart-javascript-angular-web).

<LocalCode src="quickstart-javascript-angular-web/complete-application/src/app/app.component.ts" lang="typescript" />

Here's an example dynamic header from the [React quickstart](/docs/get-started/quickstarts/spa/react).

<LocalCode src="quickstart-javascript-react-web/complete-application/src/components/LogoHeader.tsx" lang="tsx" />

And, finally, here's code from the [Vue quickstart](/docs/get-started/quickstarts/spa/quickstart-javascript-vue-web) showing `<RequireAuth>` usage which controls access to user interface elements based on whether someone has authenticated.

<LocalCode src="quickstart-javascript-vue-web/complete-application/src/components/LogoHeader.vue" lang="markup" />
...
<LocalCode src="example-node-deeplink/routes/index.js.snippet.extractURLFromState.js" lang="javascript" />
