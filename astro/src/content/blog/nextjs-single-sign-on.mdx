...
<LocalCode src="example-nextjs-single-sign-on/app/src/pages/api/auth/[...nextauth].js" lang="jsx" />
...
<LocalCode src="example-nextjs-single-sign-on/app/src/pages/_app.js" lang="jsx" />
...
<LocalCode src="example-nextjs-single-sign-on/app/src/components/login-button.jsx" lang="jsx" />

Then, you change your home component located at `src/pages/index.js` to include the `<LoginButton />` component inside `<main>`.

<LocalCode src="example-nextjs-single-sign-on/app/src/pages/index.js" lang="jsx" />
...
<LocalCode src="example-nextjs-single-sign-on/app/.env.local.dist" lang="shell" />
