...
![WebAuthn demo](/img/blogs/comprehensive-guide-to-passwordless/webauthn.png)
...
![Enable passwordless](/img/blogs/comprehensive-guide-to-passwordless/turn-on-passwordless.png)
...
![Templates](/img/blogs/comprehensive-guide-to-passwordless/duplicating-email-template.png)

![Template](/img/blogs/comprehensive-guide-to-passwordless/modifying-email-template.png)
...
![OAuth login page URL](/img/blogs/comprehensive-guide-to-passwordless/login-page-url.png)

If you visit the login page, you can see that it has a magic link option.

![Magic login](/img/blogs/comprehensive-guide-to-passwordless/login-page-with-magic-link.png)

![Enter email](/img/blogs/comprehensive-guide-to-passwordless/passwordless-email-request-form.png)
...
![Magic link email](/img/blogs/comprehensive-guide-to-passwordless/magicEmail.png)
...
![Enable MFA in the tenant](/img/blogs/comprehensive-guide-to-passwordless/tenant-settings-mfa.png)

![Enable MFA in the application](/img/blogs/comprehensive-guide-to-passwordless/application-settings-mfa.png)
...
![Set up OTP](/img/blogs/comprehensive-guide-to-passwordless/sendOtp.png)
...
![Receive OTP](/img/blogs/comprehensive-guide-to-passwordless/receiveOtp.png)

After logging in, you'll be able to save recovery codes in case you lose access to your email account.

![Recovery](/img/blogs/comprehensive-guide-to-passwordless/recovery.png)

Now that you've configured email authentication, the MFA login will be simpler in the future.

![Send OTP](/img/blogs/comprehensive-guide-to-passwordless/sendOtp2.png)
...
![TOTP](/img/blogs/comprehensive-guide-to-passwordless/totp.png)
...
![Enable tenant passkeys](/img/blogs/comprehensive-guide-to-passwordless/tenant-enable-webauthn.png)
...
![Log in with passkey](/img/blogs/comprehensive-guide-to-passwordless/selectPasskey.png)
...
![No passkey found](/img/blogs/comprehensive-guide-to-passwordless/noPasskey.png)
...
![Add passkey to existing user](/img/blogs/comprehensive-guide-to-passwordless/addPasskey.png)
...
![Enable registration](/img/blogs/comprehensive-guide-to-passwordless/enableRegistration.png)
...
![Register](/img/blogs/comprehensive-guide-to-passwordless/register.png)

On the next page of the registration, you can choose to create a passkey.

![Register passkey](/img/blogs/comprehensive-guide-to-passwordless/registerPasskey.png)
...
![Step up authentication email](/img/blogs/comprehensive-guide-to-passwordless/receiveOtp.png)
...
- [The SimpleWebAuthn JS library](https://jsr.io/@simplewebauthn/browser/doc)
- [The zxcvbn password strength library](https://github.com/dropbox/zxcvbn)
- [The FusionAuth documentation on passwordless authentication](/docs/lifecycle/authenticate-users/passwordless/)
- [The FusionAuth gateway comparisons](/blog/category/compare)
