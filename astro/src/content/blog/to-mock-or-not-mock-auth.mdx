...
<LocalCode src="example-to-mock-or-not-mock/service_mock_auth_server.py" lang="python" />
...
<LocalCode src="example-to-mock-or-not-mock/app.py" lang="python" />
...
<LocalCode src="example-to-mock-or-not-mock/test_without_mocking.py" lang="python" />
...
<LocalCode src="example-to-mock-or-not-mock/test_payments.py" lang="python" />
...
<LocalCode src="example-to-mock-or-not-mock/test_locked_user.py" lang="python" />
...
<LocalCode src="example-to-mock-or-not-mock/webhook_app.py" lang="python" />

In your test, you now **bypass** the `verify_signature` function to focus on what happens after a valid webhook is received.

<LocalCode src="example-to-mock-or-not-mock/test_webhook.py" lang="python" />
