...
Let's look at an example Below is an excerpt from the script used in FusionAuth's [Migration From ForgeRock guide](/docs/lifecycle/migrate-users/provider-specific/forgerock).

<LocalCode src="import-scripts/forgerock/import.rb.snippet.ForgerockPasswordHash.rb" lang="ruby" />
