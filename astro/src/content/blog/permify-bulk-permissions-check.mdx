...
<LocalCode src="example-permify-bulk-check/setup.sh" lang="sh" />
...
<LocalCode src="example-permify-bulk-check/bulk-check.sh" lang="sh" />
...
<LocalCode src="example-permify-bulk-check/lookup-entity.sh" lang="sh" />
