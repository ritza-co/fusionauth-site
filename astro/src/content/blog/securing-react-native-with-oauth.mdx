...
Also, note the value of **Client Id**; we'll need that later too. Click <Breadcrumb>Save</Breadcrumb>, then edit the Application again by clicking the blue <Breadcrumb>Edit</Breadcrumb> button to double check your setup.
...
<LocalCode src="example-react-native-0-71/ios/RNfusionauth/Info.plist" lang="xml" />
...
<LocalCode src="example-react-native-0-71/ios/RNfusionauth/AppDelegate.h" lang="objectivec" />

Here's the `AppDelegate.mm` file contents:

<LocalCode src="example-react-native-0-71/ios/RNfusionauth/AppDelegate.mm" lang="objectivec" />
...
<LocalCode src="example-react-native-0-71/App.tsx" lang="typescript" />
