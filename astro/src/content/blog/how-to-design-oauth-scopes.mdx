...
```mermaid title="An example request flow with OAuth scopes."
sequenceDiagram
...
* [Coinbase](https://docs.cdp.coinbase.com/coinbase-app/oauth2-integration/scopes)
...
* [X/Twitter](https://docs.x.com/fundamentals/authentication/oauth-2-0/authorization-code#scopes) - illustrates rate limits
