...
### Create your .NET Razor Pages Application

Now you are going to create a .NET Razor Pages  application. While this section builds a simple .NET Razor Pages  application, you can use the same configuration to integrate your existing .NET Razor Pages application with FusionAuth.
...
Before adding any pages, modify the stylesheet to make the HTML we add look nice. Replace the contents of the `wwwroot/css/site.css` file with the following code:
...
curl -o wwwroot/img/fusion_auth_logo.svg https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-dotnet-razor-pages/main/complete-app/MyApp/wwwroot/img/fusion_auth_logo.svg
